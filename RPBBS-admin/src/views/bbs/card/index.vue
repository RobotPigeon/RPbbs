<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="所属板块id" prop="blockId">
        <el-input
          v-model="queryParams.blockId"
          placeholder="请输入所属板块id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="cardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属板块id" align="center" prop="blockId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属板块id" prop="blockId">
          <el-input v-model="form.blockId" placeholder="请输入所属板块id" />
        </el-form-item>
      </el-form>
...
<script>
import { listCard, getCard, delCard, addCard, updateCard } from "@/api/bbs/card";
