<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="用户头像资源路径" prop="avatarPath">
        <el-input
          v-model="queryParams.avatarPath"
          placeholder="请输入用户头像资源路径"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['bbs:user_info:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['bbs:user_info:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="user_infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户简讯" align="center" prop="message" />
      <el-table-column label="用户头像资源路径" align="center" prop="avatarPath" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户简讯" prop="message">
          <el-input v-model="form.message" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="用户头像资源路径" prop="avatarPath">
          <el-input v-model="form.avatarPath" placeholder="请输入用户头像资源路径" />
        </el-form-item>
      </el-form>
...
<script>
import { listUser_info, getUser_info, delUser_info, addUser_info, updateUser_info } from "@/api/bbs/user_info";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('bbs/user_info/export', {
        ...this.queryParams
